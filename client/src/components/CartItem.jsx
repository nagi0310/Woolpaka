...
const CartItem = ({ item }) => {
  ...
  return (
    <div className="grid grid-cols-[2fr_1fr_1fr] items-center rounded-lg p-2 bg-primary-100 md:p-4 mb-4">
      ...
      <div className="flex items-center justify-between md:justify-start gap-2">
        ...
        <p className="text-primary-700">{item.quantity}</p>
        <button
          onClick={() => updateQuantity(item._id, item.quantity + 1)}
          className="h-5 w-5 shrink-0 items-center justify-center rounded-md border border-primary-600
          bg-primary-700 hover:bg-primary-600 focus:outline-none text-primary-100 cursor-pointer"
        ...
        <div className="text-end  md:w-16">
      ...
      <div className="flex gap-4  items-center justify-center">
        <button
          className="flex items-center text-sm font-medium text-primary-700 hover:text-red-500
